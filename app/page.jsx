...
export default function Home() {
  return (
    <section className="h-full">
      <div className="container mx-auto h-full lg:py-32">
        <div className="flex flex-col xl:flex-row items-center h-full justify-between">
          {/* text */}
          <div className="text-center xl:text-left mt-6">
            ...
            <p className="mt-6 min-w-[400px] text-white">Full-stack developer expert in React, Next.js & Node.js<br />
              Scalable solutions with clean, maintainable code</p>
